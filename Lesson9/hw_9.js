...
for (const course of coursesAndDurationArray) {
    ...
    let monthDuration = document.createElement('monthDuration');
    div.innerHTML = `${course.title} , ${course.monthDuration}`;
    div.append(hr,title, monthDuration);
...
for (const simpson of simpsons) {
    ...
    divE.className = 'member';

    // let {name,} = simpson;

    let name = document.createElement('h2')
    name.innerText = simpson.surname;
    ...
    divE.append(name, surname, age, info, photo);
...
for (const course of coursesArray) {
    ...
    mainBlock.classList.add('mainBox');
    ...
    modulesBlock.classList.add('modulesBlock');

    modules.appendChild(ul);
    modulesBlock.appendChild(modules);
    durationBox.append(monthDuration, hourDuration);
    mainBlock.append(title, durationBox, modulesBlock);
